...
public class OradorDAOMysqlImpl implements iOradorDAO {
    ...
    public boolean validarCredenciales(String nombreUsuario, String contrasena) {
        ...
        try (Connection connection = AdministradorDeConexiones.getConnection(); PreparedStatement statement = connection.prepareStatement("SELECT * FROM usuarios WHERE nombre_usuario = ? AND contrasena = ?")) {
